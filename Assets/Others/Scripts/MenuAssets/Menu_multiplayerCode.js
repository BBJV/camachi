...
function Awake ()
{
	...
	if (Network.HavePublicAddress()){
	 ...
	 /*var myMasterServerIP :String = "60.244.121.116";
	 //If you dont want to use the Unity masterserver..
	Network.natFacilitatorIP = myMasterServerIP;
	Network.natFacilitatorPort = 8000;//Change this
	MasterServer.ipAddress = myMasterServerIP;
	MasterServer.port = 8080;//Change this
	Network.connectionTesterIP = myMasterServerIP;
	Network.connectionTesterPort = 7080;//Change this*/
}
