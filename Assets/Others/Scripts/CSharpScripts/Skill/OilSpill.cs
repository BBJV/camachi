...
public class OilSpill : MonoBehaviour {
	...
	private float percent = -50.0f;
	private int hit = 1;
	private CarProperty owner;
	...
	void OnTriggerEnter(Collider other) {
        CarProperty car = other.transform.root.GetComponent<CarProperty>();
		if(car)
		{
			car.StartCoroutine(car.Sticky(percent, hit, collider, owner));
		}
    }
